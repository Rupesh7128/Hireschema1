...
export function decodeAuthError(
  ...
  switch (errorCode) {
    ...
    case "invite_required":
      return "Thank you for requesting an invite. We'll get back to you.";
    case "invite_rejected":
      return "This invite request was declined. Contact hello@hireschema.com if that seems wrong.";
    case "no_code":
