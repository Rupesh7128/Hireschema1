...
/** Signup URL with candidate role hint (product is candidate-only). */
export function signupUrl(
  role: SignupRole = "candidate",
...
/**
 * LinkedIn OAuth redirect — embeds signup_role for bootstrap (parity with email OTP).
