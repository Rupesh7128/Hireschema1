      ...
      <Card className="absolute inset-0 m-4 flex items-center justify-center bg-paper-0/95 border-ink-100 shadow-2">
        <CardBody className="text-center max-w-md space-y-4">
          ...
          <p className="text-small text-ink-500">
            Upload a resume or complete a 15-minute call with Hireschema AI. We&apos;ll unlock your
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            ...
            >
              ...
              Talk to Hireschema AI
            </Link>
          </div>
          <p className="text-micro text-ink-400">
            Prefer chat? Tell Hireschema AI &quot;build my profile&quot; — no resume required.
          </p>
        </CardBody>
      </Card>
    </div>
