...
const VISIBILITY_OPTIONS: {
...
}[] = [
  {
    ...
    hint: "You'll be shared with companies where Hireschema AI sees a strong fit.",
    Icon: Eye,
  },
  {
    id: "exceptional_only",
...
function SetupChecklist({
  ...
  const steps = [
    ...
    },
    {
      ...
      hint: "Hireschema AI auto-fills your profile straight from it.",
      done: resumeDone,
      cta: "Upload",
    },
    {
...
export function HomePanel({
  ...
  return (
    <div className="p-5 space-y-4 animate-fade-in">
      ...
      <CollapsibleSection title="Quick ask Hireschema AI" description="One-tap prompts for common tasks">
      ...
      <CollapsibleSection title="Voice call" description="15-minute deep dive with Hireschema AI">
