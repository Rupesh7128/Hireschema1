...
> = {
  candidate: {
    ...
    sub: "Hireschema AI reads your CV, finds India-eligible roles, and explains each match. When you want an introduction, you review the message before anything is sent from your Gmail.",
    checks: ["Invite only", "India-only", "You approve every intro"],
    ctaLabel: "Request an invite",
    ctaHref: "/invite",
    secondaryLabel: "Free CV review",
    secondaryHref: "/reviewmycv",
  },
  recruiter: {
    eyebrow: "Hireschema Beta · For recruiters in India",
    lead: "Turn a role brief into",
    accent: "a consent-first shortlist.",
    sub: "Tell Hireschema what you are hiring for. She structures the brief, ranks candidates who opted into recruiter discovery, and shows the evidence behind each match before you request an introduction.",
    checks: ["Invite only", "Opted-in candidates", "Role-scoped matching"],
    ctaLabel: "Request an invite",
    ctaHref: "/invite",
    secondaryLabel: "How Hireschema works",
