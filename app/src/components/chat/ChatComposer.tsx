        ...
        {showCoachMark && (
          <div className="flex items-start justify-between gap-3 rounded-lg border border-accent/25 bg-accent/5 px-3 py-2.5">
            <p className="text-micro text-ink-700 leading-relaxed">
              Type or tap the mic to talk with Hireschema AI. Your job matches are
            ...
            placeholder={
              isRecording
                ...
                : pendingVoiceTranscript
                  ...
                  : isAwaitingDraft
                    ? "Hireschema AI is thinking… send to barge in"
                    : isStreaming
                      ? "Send to interrupt Hireschema AI…"
