 ...
 *   1. Talk to Hireschema AI  → routes to the voice call (Hireschema AI runs it like a recruiter
...
const BASE_STEPS: Step[] = [
  ...
  {
    id: "location_scope",
    prompt: "Prefer India-based remote companies, or worldwide remote?",
    hint: "All roles are fully remote. This ranks company HQ — India vs US, Australia, and elsewhere.",
    type: "select",
    options: [
      { label: "India HQ, near my city", value: "city" },
      { label: "India HQ, my state", value: "state" },
      { label: "India-based remote companies", value: "country" },
      { label: "Worldwide remote (US, Australia, anywhere)", value: "global" },
    ],
  },
        ...
        <div className="mt-3 grid gap-2 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-small font-semibold text-ink-900">
              Talk it through with Hireschema AI
            </p>
