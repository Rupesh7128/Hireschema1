...
export type ChatShellProps = {
  ...
  /** Replace the default message list (Hireschema AI job cards, kickoff, etc.). */
  messagesSlot?: React.ReactNode;
  /** Replace the default textarea composer (Hireschema AI voice toolbar). */
  composerSlot?: React.ReactNode;
  /** External scroll anchor — e.g. Hireschema AI passes its own ref. */
  messagesEndRef?: React.Ref<HTMLDivElement>;
  /** Extra values that should trigger scroll-to-bottom (Hireschema AI streaming, voice, etc.). */
  scrollDeps?: unknown[];
};
