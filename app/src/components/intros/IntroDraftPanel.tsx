      ...
      {!gmailConnected && (
        <div className="space-y-2">
          <p className="text-micro text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
            Looks good? Connect Google to send from your Gmail — send-only access, we never read your
            inbox.
          </p>
          <GoogleConnectCard />
        </div>
  ...
  if (inProgress && !introDraft && !followupReady && !thankyouReady) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-small font-medium text-ink-800">Hireschema is preparing your intro</p>
      ...
      {showIntroDraft && introDraft && (
        <div className="flex flex-col gap-3">
          ...
          {!detail?.gmail_connected && (
            <div className="space-y-2">
              <p className="text-micro text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                Draft is ready — connect Google to send from your Gmail (send-only; we never read
                your inbox).
              </p>
              <GoogleConnectCard />
            </div>
