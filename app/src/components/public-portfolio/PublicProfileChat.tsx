...
export function PublicProfileChat({
  ...
  const emptyState = (
    <p className="text-small text-ink-600 text-left">
      Hi! I&apos;m Hireschema AI. Ask me about {candidateLabel}&apos;s background, skills, or
    ...
    <ChatShellDrawer
      ...
      header={
        <div className="flex items-center gap-3 px-4 py-3 min-w-0">
          <HireschemaFace size="sm" />
          <div className="min-w-0">
            <p className="text-small font-semibold text-ink-900 truncate">Hireschema AI</p>
