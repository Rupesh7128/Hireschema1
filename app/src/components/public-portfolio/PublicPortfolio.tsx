  ...
  if (!hasContent) {
    return (
      <p className="text-small text-ink-500">
        Hireschema AI is still building this candidate&apos;s intelligence profile. Use the chat
          ...
          {tab === "about" && (
            <section className="space-y-6">
              {profile.summary ? (
                ...
                <p className="text-small text-ink-500">
                  Ask Hireschema AI below about {label}&apos;s background and fit.
                </p>
              )}
          ...
          {tab === "resume" && (
            <section className="space-y-8">
              ...
              {profile.experience.length === 0 && profile.education.length === 0 && (
                <p className="text-small text-ink-500">
                  Detailed experience is available through Hireschema AI — use chat below.
                </p>
              )}
            </section>
          )}
              ...
              {profile.contact.hidden ? (
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Link
                      href={`/signup?mode=signin&from=${encodeURIComponent(`/p/${profile.slug}`)}`}
