    ...
    return (
      <div className="border-2 border-dashed border-ink-100 rounded-2xl p-10 text-center bg-ink-50">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-ink-900">Hireschema AI is extracting your skills and experience</p>
        </div>
      </div>
    );
  }
  ...
  if (state === "done") {
    return (
      <div className="border border-ink-100 rounded-2xl p-6 text-center bg-ink-50">
        ...
        <p className="text-ink-900 text-sm mt-1">Hireschema AI now has everything she needs to find your matches.</p>
      </div>
    );
  }
