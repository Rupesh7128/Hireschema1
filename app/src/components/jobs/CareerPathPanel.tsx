 ...
 *      re-score, shown by the "Hireschema AI is scanning fresh roles…" indicator.
 *
 * Visual structure:
 *   ┌─ summary ─────────────────────────────────┐
            ...
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-micro text-ink-500 max-w-xs">
                  Hireschema AI reads your profile and maps where you are today to where
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4">
        ...
        {refreshing && (
          <div className="flex items-center gap-2 text-small text-ink-500 px-1">
            ...
            Hireschema AI is scanning fresh roles for your path…
          </div>
        )}
        ...
        {searched && !jobsError && jobs.length === 0 && !refreshing && !sourceAvailable && (
          <EmptyState
            ...
            description="Hireschema AI can't reach the job source right now. This is usually a configuration issue on our side, not a lack of roles — please try again shortly."
            action={
              <Button
                variant="secondary"
                size="sm"
        ...
        {searched && !jobsError && jobs.length === 0 && !refreshing && sourceAvailable && (
          <EmptyState
            ...
            description="Hireschema AI is pulling fresh roles for your path. Check back in a minute or two."
          />
        )}
