...
export function TailoredResumeSettings() {
  ...
  async function save() {
    ...
    try {
      ...
      toast.success(
        enabled
          ? "Tailored resumes enabled — Hireschema AI can generate role-specific CVs"
  ...
  return (
    <Card>
      <CardHeader
        ...
        description="Let Hireschema AI generate a role-specific resume from your profile when you prepare an application."
      />
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 space-y-1">
                ...
                <p className="text-micro text-ink-500 leading-relaxed">
                  Off by default. When on, Hireschema AI rewrites your CV for each job using your
