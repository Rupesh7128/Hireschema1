      ...
      <div className="min-w-0">
        ...
        <p className="text-micro text-ink-500">
          {connected
            ...
            : "Connect so Hireschema AI can send approved intros from your Gmail and add Meet links for booked calls."}
        </p>
        {loading ? (
          ...
          <ul className="mt-1.5 list-disc space-y-0.5 pl-4 text-micro text-ink-500">
            ...
            <li>Optional Meet links when you book with Hireschema AI</li>
          </ul>
        )}
      </div>
