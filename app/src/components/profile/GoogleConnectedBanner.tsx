...
const BENEFITS = [
  ...
  },
  {
    ...
    body: "When you book a voice session with Hireschema AI, we can create the calendar event with a Meet link.",
  },
  {
    Icon: Shield,
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-micro text-ink-600">
            {gmailEmail
              ? `You're connected as ${gmailEmail}. Hireschema AI can send approved intros from this inbox.`
              : "You're connected. Hireschema AI can send approved intros from your Gmail."}
          </p>
        </div>
