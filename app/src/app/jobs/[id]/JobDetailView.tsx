 ...
 * match breakdown, required skills, Hireschema AI's take) but as a focused standalone
...
export function JobDetailView({ jobId }: JobDetailViewProps) {
  ...
  // Assets-first flow is chat-mediated: Hireschema AI generates and renders the kit in
  ...
  const handlePrepare = async () => {
    ...
    try {
      ...
      toast.error((e as Error).message || "Couldn't open Hireschema AI chat");
    ...
    <div className="space-y-6">
          ...
          {gaps.length > 0 && (
            <div className="space-y-1.5">
              ...
              <p className="text-micro text-ink-400">
                Ask Hireschema AI how to close these — or whether they’re really needed.
              </p>
            </div>
          )}
        </div>
      ...
      <div className="rounded-xl border border-ink-100 bg-paper-1 p-4 space-y-3">
        ...
        <p className="text-micro text-ink-500">
          Helps Hireschema AI learn which roles work for you — stored in your application dossier.
        </p>
        <select
          value={outcomeStage}
        ...
        <Button
          ...
          onClick={() => {
            ...
            void recordJobOutcome(job.job_id, outcomeStage, outcomeNotes || undefined)
              .then(() => toast.success("Outcome saved — Hireschema AI will use this to improve picks"))
      ...
      <div className="space-y-2 pt-4 border-t border-ink-100">
        <Button
          ...
          className="w-full"
        >
          {kitPreparing ? "Opening Hireschema AI chat…" : "Prepare application kit"}
        </Button>
        <p className="text-micro text-ink-400 text-center">
          Hireschema AI will generate your resume, cover letter & interview prep in chat.
        </p>
