...
Violation of these rules may result in account termination and legal action under applicable law.`,
  },
  {
    ...
    content: `Connecting your Google account is optional. If you connect it, you grant Hireschema the gmail.send and calendar.events scopes. Gmail access allows Hireschema AI to send an intro email only after your explicit approval. Calendar access adds an optional reminder event for an Hireschema AI call you schedule; the call still happens privately inside Hireschema, and we do not create or promise a Google Meet link.
...
• Never requiring Google Calendar to start or schedule an Hireschema AI call
...
You can revoke Google access at any time from Google Account settings → Third-party apps.`,
  ...
  {
    id: "career-discovery",
    title: "7. Hireschema AI career-discovery calls",
    content: `An Hireschema AI career-discovery call is a private 15-minute conversation designed to understand your experience, skills, languages, location, and job preferences.
...
During this phase, Hireschema AI does not automatically change your profile or job preferences from the call. Any proposed facts or preference updates must be reviewed and confirmed by you before they are applied.`,
  },
  {
