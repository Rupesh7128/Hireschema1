 ...
 * Hireschema AI avatar, two-column layout on desktop (content left, illustration right).
 */
...
import { HireschemaFace } from "@/components/hireschema-ai/HireschemaFace";
        ...
        <div className="space-y-5 rounded-lg border border-ink-100 bg-paper-1 p-5 shadow-1">
          <div className="space-y-2">
            ...
            <p className="text-micro text-ink-400">
              Hireschema AI reads your CV to build your profile and matches. You can refine
          ...
          >
            {saving ? "Setting up your dashboard…" : "Upload & meet Hireschema AI"}
          </Button>
        </div>
      </div>
    </div>
...
export function OnboardingFlow({
  ...
  useEffect(() => {
    if (profileCheckDone.current) return;
