 ...
 *
 * Full-screen chat UI matching the Hireschema AI design system:
 ...
 *   - Mic button via useVoice (same as Hireschema AI chat)
 */
        ...
        <div className="shrink-0 border-t border-ink-100 bg-paper-1 px-4 py-3">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-micro text-ink-300 mt-1.5 text-center">
              Hireschema AI evaluates communication, accuracy, and structure
            </p>
          </div>
        </div>
      )}
  ...
  return (
    <Card className="border-ink-100 shadow-2">
      <CardHeader
        ...
        description="Hireschema AI's structured evaluation of your answers"
        action={
          score !== null ? (
