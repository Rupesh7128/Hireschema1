...
export function AuthCallbackClient() {
  ...
  const [errorRole, setErrorRole] = useState<SignupRole>("candidate");
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        if (isInviteAccessError(err)) {
          clearSignupRole();
          clearPostAuthRedirect();
          await redirectForInviteAccess(supabase, (href) => router.replace(href), err);
          return;
        }
        const message =
