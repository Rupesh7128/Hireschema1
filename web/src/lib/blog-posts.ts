...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "An email from the candidate's own Gmail gets a 3× higher reply rate than recruiter outreach. Here's the data behind the mechanic that powers Hireschema.",
    tag: "Insights",
    date: "2026-01-15",
    readMins: 5,
    body: [
      ...
      "Hireschema's intro flow keeps the candidate in control: you approve the draft, Hireschema AI handles the research, and the hiring manager sees a human connection, not spam.",
  ...
  },
  {
    ...
    excerpt:
      "Consent logs, bias audits, and right-to-delete aren't optional any more. Here's how Hireschema builds compliance into its core data model.",
    tag: "Compliance",
    date: "2026-01-08",
    readMins: 7,
    body: [
      ...
      "Hireschema logs every collection event in consent_log, surfaces privacy@hireschema.com in product flows, and runs bias audits on match scores.",
