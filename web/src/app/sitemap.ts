...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { url: "/alternatives/naukri", priority: 0.85, changeFrequency: "monthly" as const },
    { url: "/alternatives/instahyre", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/alternatives/cutshort", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/alternatives/linkedin-jobs", priority: 0.8, changeFrequency: "monthly" as const },
