            ...
            <div className="bg-paper-1 border border-ink-100 rounded-lg overflow-hidden font-mono text-small">
              ...
              <div className="px-4 py-5 text-ink-600 leading-relaxed space-y-3">
                ...
                <p>
                  ...
                  [•••] — Hireschema AI flagged an 87% match on skills and comp band.
                </p>
...
const STEPS = [
  {
    icon: MessageCircle,
    n: "01",
    title: "Tell Hireschema AI about you",
    body: "Upload your resume or paste your LinkedIn. Hireschema AI understands your skills, seniority, salary expectations, and the roles you actually want.",
  },
  {
    icon: Percent,
    n: "02",
  ...
  },
  {
    ...
    body: "Hireschema finds the hiring manager, drafts the email in your voice, and sends it via your Gmail after you sign off. No spam. No cold templates.",
  },
];
        ...
        <Reveal>
          <div className="bg-paper-1 border border-ink-100 rounded-lg p-12 md:p-16 text-center">
            ...
            <p className="text-body text-ink-500 mb-8 max-w-prose mx-auto leading-relaxed">
              ...
              Request an invite with your email — we&apos;ll approve access manually.
            </p>
