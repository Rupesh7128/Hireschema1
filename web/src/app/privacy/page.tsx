...
const SECTIONS = [
  {
    id: "overview",
    title: "1. Overview",
    content: `Hireschema ("Hireschema", "we", "us") operates an AI-powered recruiting platform for candidates in India (phone-verified with +91 when configured). This Privacy Policy explains how we collect, use, store, and protect your personal data in compliance with India's Digital Personal Data Protection (DPDP) Act 2023.
...
Conversation data: Chat messages and voice transcripts from your interactions with Hireschema AI. Retained for 90 days.
...
Gmail OAuth data: We store OAuth tokens to send intro emails on your behalf. We never read your inbox. Scope: gmail.send only.`,
  },
  {
    id: "purpose",
    ...
    <main className="py-16 bg-paper-1">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="mb-10">
          ...
          <p className="text-ink-500 text-sm">Effective: January 2026 · India</p>
        </div>
