...
const FAQ = [
  {
    ...
    a: "Go to the app, sign in with LinkedIn, verify your +91 number, and Hireschema AI will show your matches on the dashboard.",
  },
  {
    q: "Where are my job matches?",
    a: "Open Matches on the left panel of your dashboard — chat with Hireschema AI on the right for questions and intros.",
  },
  {
