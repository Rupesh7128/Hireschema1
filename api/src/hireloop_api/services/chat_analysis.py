"""
Chat document analysis — resume + JD fit for Hireschema AI, resume-vs-role for Nitya.
...
def analyze_resume_parsed(
    ...
    *,
    ...
    return {
        ...
        "gaps": gaps,
        "strengths": strengths
        or ["CV uploaded — fill the gaps below so Hireschema AI can match you better"],
