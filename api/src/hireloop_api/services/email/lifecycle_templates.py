...
def render_welcome_email(
    *,
    ...
    # Candidate-only product — recruiter welcome path retired.
    body = (
        paragraph(f"Hi {name},")
        + paragraph(
            "You're in. <strong>Hireschema AI</strong> reads your profile, "
            "finds live roles, scores your fit, and helps you track applications "
            "with your approval every step of the way."
        )
        + bullet_list(
            [
                "Chat by text or voice — tell Hireschema AI what you want next",
                "See matched roles ranked for your background",
                "Save jobs and prepare materials per role",
            ]
        )
    )
    return (
        ...
        brand_shell(
            "Welcome — Hireschema AI is on your side",
            body,
            f"{base}/dashboard",
            "Open Hireschema",
            app_base=base,
            preheader="Hireschema AI is ready to help you find and track roles.",
        ),
    )
...
def render_first_job_found_email(
    *,
    ...
    body = (
        ...
        + muted_paragraph(
            "Hireschema AI will keep scanning your market overnight. Open your dashboard to save this role, "
...
def render_intro_requested_candidate_email(
    *,
    ...
    body = (
        ...
        + bullet_list(
            [
                "Hireschema AI / Nitya will draft a personalised note",
...
def render_recruiter_approach_candidate_email(
    *,
    ...
    body = (
        ...
        + muted_paragraph(
            "Open your intro inbox to accept, decline, or ask Hireschema AI for advice before you reply."
        )
    )
    return (
...
def render_notification_email(category: str, data: dict[str, Any]) -> tuple[str, str]:
    ...
    if cat == "interview_reminders":
        ...
        body = paragraph(
            f"Your <strong>{session}</strong> with Hireschema AI is scheduled for <strong>{when}</strong>."
        ) + muted_paragraph("Join from Hireschema — voice or text, your choice.")
        is_reminder = bool(data.get("is_reminder"))
        subject = (
            f"Reminder: {session} tomorrow" if is_reminder else f"Booked: {session} with Hireschema AI"
        )
    ...
    if cat == "aarya_digest":
        ...
        body = paragraph("Here's what Hireschema AI did for you this week:") + bullet_list(
            [
        ...
        return (
            "Your weekly career digest from Hireschema AI",
            brand_shell(
    ...
    if cat == "platform_updates":
        ...
        body = extra or paragraph(
            "We've shipped improvements to job matching, intros, and your Hireschema AI chat experience."
        )
