...
flows so both the Hireschema AI tool and the recruiter REST routes share one code path:
    ...
    *,
    ...
    if hm and hm["email"]:
        ...
        return {
            ...
            "direction": "candidate_to_hm",
            "message": (
                "We're drafting your intro email. Connect Google in Profile, "
    ...
    if not hiring_manager_id:
        return {
            ...
            "message": (
                ...
                "Try another listing or ask Hireschema AI to search again."
            ),
        }
    ...
    return {
        ...
        "message": (
            "Requested Apify hiring-manager lookup. We'll verify the contact "
            "and draft your email."
            if hm_enrich_queued
            else "Intro request created. We'll enrich the contact and draft your email."
        ),
    }
