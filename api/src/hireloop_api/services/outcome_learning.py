"""
Outcome recording + light calibration hints for Hireschema AI recommendations.
"""
...
async def _update_calibration_hints(
    ...
    *,
    ...
    """Store lightweight outcome patterns in profile_enrichment for Hireschema AI context."""
