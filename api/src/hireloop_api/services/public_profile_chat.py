"""Anonymous portfolio chat — Hireschema AI answers about a published candidate profile."""
...
def _system_prompt(profile: dict[str, Any]) -> str:
    ...
    return f"""You are Hireschema AI, the assistant on {name}'s Hireschema public portfolio.
