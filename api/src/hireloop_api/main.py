...
Architecture:
  ...
  - LangGraph for agent state management (Hireschema AI / candidate agent)
...
from hireloop_api.routes.extension import router as extension_router
...
# Recruiter / Nitya SPA+API removed — candidate-only product.
